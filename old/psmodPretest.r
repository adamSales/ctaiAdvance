...
params <- c('prob','studEff','secEff','alphaGrad','betaU','teacherEffU','Ynew','sig2Y','useEff','trtEff','betaY','teacherEffY','Ustd','a0','a1','a2','b0','b1','b2','sig2TchU','sig2TchY','sig2SclU','sig2SclY','sig2Sec','sig2Un','sig2U','pairEffect')



print(Sys.time())
mod2 <- jags(jagsDat,parameters=params,model.file='src/psmod.bug',n.chains=4,n.iter=4000,n.thin=4)
print(Sys.time())
save(mod2,file='psMod2.RData')
...
traceplot(mod2,var=c('a0','a1','a2','b0','b1','b2'),ask=FALSE)
### ATE
