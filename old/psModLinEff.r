...
print(Sys.time())
modLinEff <- jags(jagsDat,parameters=params,model.file='src/psmod.bug',n.chains=4,n.iter=4000,n.thin=4)
print(Sys.time())
save(modLinEff,file='psModLinEff.RData')

library(jagstools)
cat('LINEAR EFFECT SIMULATION \n\n')
print(jagsresults(modLinEff,c('b0','b1','b2')))


### results:
pdf('linSimResults.pdf')
attach.jags(modLinEff)
