...
print(Sys.time())
mod <- jags(jagsDat,parameters=params,model.file='src/psmodLinInt.bug',n.chains=4,n.iter=10000,n.thin=5)
print(Sys.time())
save(list=c('mod',unlist(jagsDat)),file=paste0('~/Google Drive/CTmodels/psModWlinInt',Sys.Date(),'.RData'))
