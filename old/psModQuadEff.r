...
print(Sys.time())
modQuadEff <- jags(jagsDat,parameters=params,model.file='src/psmod.bug',n.chains=4,n.iter=4000,n.thin=4)
print(Sys.time())
save(modQuadEff,file='psModQuadEff.RData')

library(jagstools)
cat('QUADRATIC EFFECT SIMULATION \n\n')
print(jagsresults(modQuadEff,c('b0','b1','b2')))


### results:
pdf('quadSimResults.pdf')
attach.jags(modQuadEff)
