...
print(Sys.time())
mod <- jags(jagsDat,parameters=params,model.file='src/psmodLin.bug',n.chains=4,n.iter=10000,n.thin=5)
print(Sys.time())
save(mod,file=paste0('~/Google Drive/CTmodels/psModWlin',Sys.Date(),'.RData'))
