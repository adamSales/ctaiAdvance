...
print(Sys.time())
modNoEff <- jags(jagsDat,parameters=params,model.file='src/psmodLin2.bug',n.chains=4,n.iter=4000,n.thin=4)
print(Sys.time())
save(modNoEff,file=paste0('~/Google Drive/CTmodels/psModNoEff',Sys.Date(),'.RData'));
print(Sys.time())

pdf('output/noEffPlot2.pdf')
...
print(Sys.time())
mod <- jags(jagsDat,parameters=params,model.file='src/psmodLin2.bug',n.chains=4,n.iter=4000,n.thin=4)
print(Sys.time())
save(mod,file=paste0('~/Google Drive/CTmodels/psModConstEff',Sys.Date(),'.RData'));

pdf('output/constEffPlot2.pdf')
...
mod <- jags(jagsDat,parameters=params,model.file='src/psmodLin2.bug',n.chains=4,n.iter=4000,n.thin=4)
print(Sys.time())
save(mod,te,file=paste0('~/Google Drive/CTmodels/psModLinEff',Sys.Date(),'.RData'));
print(Sys.time())

pdf('output/linEffPlot2.pdf')
b <- mod$BUGSoutput$sims.list$b
studEff <- mod$BUGSoutput$sims.list$studEff
trtEff <-  mod$BUGSoutput$sims.list$trtEff
studEff90 <- quantile(studEff,c(0.05,0.95))
...
mod <- jags(jagsDat,parameters=params,model.file='src/psmodLin2.bug',n.chains=4,n.iter=4000,n.thin=4)
print(Sys.time())
save(mod,te,file=paste0('~/Google Drive/CTmodels/psModQuadEff',Sys.Date(),'.RData'));
print(Sys.time())


pdf('output/quadEffPlot2.pdf')
b <- mod$BUGSoutput$sims.list$b
studEff <- mod$BUGSoutput$sims.list$studEff
trtEff <-  mod$BUGSoutput$sims.list$trtEff
studEff90 <- quantile(studEff,c(0.05,0.95))
