...
print(Sys.time())
realModels$lin <- jags.parallel(jagsDat,parameters=params,model.file='src/jags/psmodLin.bug',n.chains=4,n.iter=4000,n.thin=4)
print(Sys.time())
realModels$quad <- jags.parallel(jagsDat,parameters=params,model.file='src/jags/psmodQuad.bug',n.chains=4,n.iter=4000,n.thin=4)
print(Sys.time())

print(Sys.time())
realModels$disc <- jags.parallel(jagsDat,parameters=params,model.file='src/jags/psmodDisc.bug',n.chains=4,n.iter=4000,n.thin=4)
print(Sys.time())
save(list=ls(),file=paste0('~/Google Drive/CTmodels/realModels',Sys.Date(),'.RData'))
